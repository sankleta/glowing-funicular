class UnionFind:
    ...
    def find(self, element_no):
        ...
        return self.find_root_and_compress(element[0], element_no - 1)
    ...
    def union(self, first_element_no, second_element_no):
        ...
        if first_root_index != second_root_index:
            ...
            if first_cluster_root[1] > second_cluster_root[1]:
                self.elements[second_cluster_root[0]][1] = first_cluster_root[0]
            elif second_cluster_root[1] > first_cluster_root[1]:
                self.elements[first_cluster_root[0]][1] = second_cluster_root[0]
            else:
                first_cluster_root[1] += 1
                self.elements[second_cluster_root[0]][1] = first_cluster_root[0]
            self.size -= 1
